...
export function appendNavigationItem(item, parentId) {
    return (dispatch, getState) => {
        const { navigation } = getState().spacenow;
        return dispatch({
            type: SET_NAVIGATION,
            navigation: SpacenowUtils.appendNavItem(navigation, item, parentId)
        });
    }
}
...
export function prependNavigationItem(item, parentId) {
    return (dispatch, getState) => {
        ...
        return dispatch({
            type: SET_NAVIGATION,
            navigation: SpacenowUtils.prependNavItem(navigation, item, parentId)
        });
    }
}
...
export function updateNavigationItem(id, item) {
    return (dispatch, getState) => {
        ...
        return dispatch({
            type: SET_NAVIGATION,
            navigation: SpacenowUtils.updateNavItem(navigation, id, item)
        });
    }
}
...
export function removeNavigationItem(id) {
    return (dispatch, getState) => {
        ...
        return dispatch({
            type: SET_NAVIGATION,
            navigation: SpacenowUtils.removeNavItem(navigation, id)
        });
    }
}
