...
function WidgetListingsCategory(props) {
    ...
    return (
        ...
        <Paper className="w-full rounded-8 shadow-none border-1">
            ...
            <div className="text-center pt-12 pb-28">
                ...
                <Typography className="text-16" color="textSecondary">Total Listings Category</Typography>
            </div>
        </Paper>
    );
}

export default React.memo(WidgetListingsCategory);
