        ...
        <SpacenowPageCarded
                    ...
                    <div className="flex flex-1 w-full items-center justify-between">
                        ...
                        <SpacenowAnimate animation="transition.slideRightIn" delay={300}>
                            <Button
                                ...
                                onClick={() => dispatch('saveProduct function')} //dispatch(Actions.saveProduct(form)
                            >
                                Save
                            </Button>
                        </SpacenowAnimate>
            ...
            contentToolbar={
                ...
                >
                    ...
                    <Tab className="h-64 normal-case" label="User Documents"/>
                    <Tab className="h-64 normal-case" label="Bank Account"/>
...
export default withReducer('eCommerceApp', reducer)(User);
