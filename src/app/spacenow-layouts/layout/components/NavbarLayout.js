...
import UserNavbarHeader from 'app/spacenow-layouts/shared-components/UserNavbarHeader';
import Logo from 'app/spacenow-layouts/shared-components/Logo';
import NavbarFoldedToggleButton from 'app/spacenow-layouts/shared-components/NavbarFoldedToggleButton';
import NavbarMobileToggleButton from 'app/spacenow-layouts/shared-components/NavbarMobileToggleButton';
import Navigation from 'app/spacenow-layouts/shared-components/Navigation';
...
function NavbarLayout(props) {
    ...
    return (
        <div className={clsx("flex flex-col overflow-hidden h-full", props.className)}>
            ...
            <SpacenowScrollbars className={clsx(classes.content)}>
