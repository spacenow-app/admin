...
function SpacenowHighlight(props) {
    ...
    function trimCode() {
        ...
        // can be formatted properly while using spacenow-highlight
        // component
...
SpacenowHighlight.propTypes = {
    component: PropTypes.node
};
SpacenowHighlight.defaultProps = {
    component: `code`
};

export default React.memo(SpacenowHighlight);
