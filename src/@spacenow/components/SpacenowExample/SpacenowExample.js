...
import { SpacenowHighlight } from '@spacenow';
...
function SpacenowExample(props) {
                ...
                <div className={currentTab === 1 ? 'flex flex-1' : 'hidden'}>
                    {raw && (
                        <div className="flex flex-1">
                            <SpacenowHighlight component="pre" className="language-javascript w-full">
                                {raw}
                            </SpacenowHighlight>
                        </div>
                    )}
...
SpacenowExample.propTypes = propTypes;
SpacenowExample.defaultProps = defaultProps;

export default SpacenowExample;
