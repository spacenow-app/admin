...
function SpacenowMessage(props) {
    const dispatch = useDispatch();
    const state = useSelector(({ spacenow }) => spacenow.message.state);
    const options = useSelector(({ spacenow }) => spacenow.message.options);
...
export default React.memo(SpacenowMessage);
