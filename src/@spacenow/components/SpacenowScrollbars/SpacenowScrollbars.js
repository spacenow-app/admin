...
const SpacenowScrollbars = React.forwardRef(function SpacenowScrollbars(props, ref) {
    ref = ref || createRef();
...
function mapStateToProps({ spacenow }) {
    return {
        customScrollbars: spacenow.settings.current.customScrollbars
    }
}

SpacenowScrollbars.propTypes = {
...
SpacenowScrollbars.defaultProps = {
    className: '',
    enable: true,
...
export default connect(mapStateToProps, null, null, { forwardRef: true })(React.memo(SpacenowScrollbars));
