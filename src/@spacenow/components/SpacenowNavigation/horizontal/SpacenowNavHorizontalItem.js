...
import { SpacenowUtils, NavLinkAdapter } from '@spacenow';
...
function SpacenowNavHorizontalItem(props) {
...
SpacenowNavHorizontalItem.propTypes = {
...
SpacenowNavHorizontalItem.defaultProps = {};

const NavHorizontalItem = withRouter(React.memo(SpacenowNavHorizontalItem));
