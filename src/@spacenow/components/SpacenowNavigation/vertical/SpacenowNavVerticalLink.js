...
function SpacenowNavVerticalLink(props) {
...
SpacenowNavVerticalLink.propTypes = {
...
SpacenowNavVerticalLink.defaultProps = {};

const NavVerticalLink = withRouter(React.memo(SpacenowNavVerticalLink));
