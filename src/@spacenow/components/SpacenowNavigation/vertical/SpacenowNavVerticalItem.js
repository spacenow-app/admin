...
import { NavLinkAdapter, SpacenowUtils } from '@spacenow';
...
function SpacenowNavVerticalItem(props) {
    ...
    return (
        ...
        >
            ...
            {item.badge && (
                <SpacenowNavBadge badge={item.badge} />
            )}
        </ListItem>
    );
}

SpacenowNavVerticalItem.propTypes = {
...
SpacenowNavVerticalItem.defaultProps = {};

const NavVerticalItem = withRouter(React.memo(SpacenowNavVerticalItem));
