...
function SpacenowSidePanel(props)
{
        ...
        <React.Fragment>
            <Hidden mdDown>
                <Paper
                    ...
                    square={true}
                >
                    <SpacenowScrollbars className={clsx("content", classes.content)}>
                        {props.children}
                    </SpacenowScrollbars>
...
SpacenowSidePanel.propTypes = {};
SpacenowSidePanel.defaultProps = {
    position: "left",
    opened  : true
};

export default React.memo(SpacenowSidePanel);
