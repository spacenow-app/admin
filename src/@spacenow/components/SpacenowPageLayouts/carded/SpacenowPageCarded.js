...
import SpacenowPageCardedSidebar from './SpacenowPageCardedSidebar';
import SpacenowPageCardedHeader from './SpacenowPageCardedHeader';
...
const useStyles = makeStyles(theme => ({
    ...
    topBg: {
        ...
        top: 0,
        height: headerHeight,
        background: 'linear-gradient(to right, ' + theme.palette.primary.main + ' 0%, ' + theme.palette.primary.main + ' 100%)',
...
const SpacenowPageCarded = React.forwardRef(function (props, ref) {
        ...
        <div className={clsx(classes.root, props.innerScroll && classes.innerScroll)} ref={rootRef}>
            ...
            <div className="flex container w-full">
                ...
                >
                    ...
                    <SpacenowPageCardedHeader header={props.header} classes={classes} />
                    ...
                    <div className={clsx(classes.contentCard, props.innerScroll && 'inner-scroll')}>
                        ...
                        {props.content && (
                            <SpacenowScrollbars className={classes.content} enable={props.innerScroll} scrollToTopOnChildChange={props.innerScroll}>
                                {props.content}
                            </SpacenowScrollbars>
                        )}
                    </div>
...
SpacenowPageCarded.defaultProps = {};

export default React.memo(SpacenowPageCarded);
