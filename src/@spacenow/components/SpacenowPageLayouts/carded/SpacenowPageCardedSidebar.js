...
import SpacenowPageCardedSidebarContent from './SpacenowPageCardedSidebarContent';

function SpacenowPageCardedSidebar(props, ref) {
    ...
    return (
        <React.Fragment>
            <Hidden lgUp={props.variant === 'permanent'}>
                ...
                >
                    <SpacenowPageCardedSidebarContent {...props} />
                </Drawer>
            </Hidden>
...
export default React.forwardRef(SpacenowPageCardedSidebar);
