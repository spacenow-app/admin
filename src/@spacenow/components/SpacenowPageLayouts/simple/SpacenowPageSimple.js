...
import SpacenowPageSimpleSidebar from './SpacenowPageSimpleSidebar';
import SpacenowPageSimpleHeader from './SpacenowPageSimpleHeader';
...
const SpacenowPageSimple = React.forwardRef(function (props, ref) {
    // console.info("render::SpacenowPageSimple");
        ...
        <div className={clsx(classes.root, props.innerScroll && classes.innerScroll)} ref={rootRef}>
            ...
            <div className="flex flex-auto flex-col container z-10">
                ...
                {props.header && props.sidebarInner && (
                    <SpacenowPageSimpleHeader header={props.header} classes={classes} />
                )}

                <div className={classes.wrapper}>

                    {(props.leftSidebarHeader || props.leftSidebarContent) && (
                        <SpacenowPageSimpleSidebar
                            position="left"
                    ...
                    {/*>*/}
                    <SpacenowScrollbars className={classes.contentWrapper} enable={props.innerScroll && !props.sidebarInner}>
...
SpacenowPageSimple.defaultProps = {};

export default React.memo(SpacenowPageSimple);
