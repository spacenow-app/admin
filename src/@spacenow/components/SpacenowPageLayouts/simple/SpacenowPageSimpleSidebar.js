...
import SpacenowPageSimpleSidebarContent from './SpacenowPageSimpleSidebarContent';

function SpacenowPageSimpleSidebar(props, ref) {
    ...
    return (
        <React.Fragment>
            <Hidden lgUp={props.variant === 'permanent'}>
                ...
                >
                    <SpacenowPageSimpleSidebarContent {...props} />
                </Drawer>
            </Hidden>
...
export default React.forwardRef(SpacenowPageSimpleSidebar);
