...
import { SpacenowLayouts } from '@spacenow';
...
function SpacenowLayout(props) {
    const dispatch = useDispatch();
    const defaultSettings = useSelector(({ spacenow }) => spacenow.settings.defaults);
    ...
    const Layout = SpacenowLayouts;
    return (
        <Layout classes={{ root: classes.root }} {...props} />
    );
}

export default withRouter(React.memo(SpacenowLayout));
